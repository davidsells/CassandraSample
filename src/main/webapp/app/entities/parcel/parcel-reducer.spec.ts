...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './parcel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARCEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARCEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARCEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARCEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARCEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARCEL actions', async () => {
      const expectedActions = [
        {
