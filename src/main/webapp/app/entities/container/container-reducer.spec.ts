...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './container.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTAINER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTAINER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTAINER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTAINER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTAINER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTAINER actions', async () => {
      const expectedActions = [
        {
