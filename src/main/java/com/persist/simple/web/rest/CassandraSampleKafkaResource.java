...
@RestController
@RequestMapping("/api/cassandra-sample-kafka")
public class CassandraSampleKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CassandraSampleKafkaResource.class);
    ...
    public CassandraSampleKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
